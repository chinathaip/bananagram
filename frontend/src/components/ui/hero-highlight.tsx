...
export const HeroHighlight = ({
	...
	return (
		<div
			className={cn("group relative flex h-[40rem] w-full items-center justify-center", containerClassName)}
...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string }) => {
	return (
		<motion.span
			...
			className={cn(
				`relative inline-block rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 px-1 pb-1 dark:from-yellow-400 dark:to-yellow-500`,
				className
			)}
		>
			{children}
