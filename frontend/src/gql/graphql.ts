...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, username: string, bio: string, email: string, display_name: string, is_owner: boolean, created_at: any, profile_picture: string } };
