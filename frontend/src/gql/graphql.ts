...
export type CommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', id: number, content: string, post_id: number, created_at: any, updated_at?: any | null, user: { __typename?: 'User', id: string, username: string, display_name: string, is_owner: boolean, created_at: any, profile_picture: string } }> };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PostConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, totalEdges?: number | null }, edges: Array<{ __typename?: 'PostEdge', node: { __typename?: 'Post', id: number, content: string, user_id: string, category_name: string, likes: number, user_liked: boolean, created_at: any, updated_at?: any | null, user: { __typename?: 'User', id: string, username: string, bio: string, email: string, display_name: string, is_owner: boolean, created_at: any, profile_picture: string } } }> } };
...
export type PostQuery = { __typename?: 'Query', post: { __typename?: 'Post', id: number, content: string, likes: number, category_name: string, created_at: any, user_liked: boolean, user: { __typename?: 'User', id: string, username: string, bio: string, email: string, following: number, followers: number, display_name: string, is_following: boolean, is_owner: boolean, created_at: any, profile_picture: string } } };
