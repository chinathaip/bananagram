...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PostConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, totalEdges?: number | null }, edges: Array<{ __typename?: 'PostEdge', node: { __typename?: 'Post', id: number, content: string, user_id: string, category_id: number, likes: number, user_liked: boolean, created_at: any, updated_at?: any | null, user: { __typename?: 'User', id: string, username: string, bio: string, email: string, display_name: string, is_owner: boolean, created_at: any, profile_picture: string }, category: { __typename?: 'Category', id: number, name: string } } }> } };
