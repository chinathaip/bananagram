...
export type PostQuery = { __typename?: 'Query', post: { __typename?: 'Post', id: number, content: string, category_name: string, user: { __typename?: 'User', id: string, username: string, bio: string, email: string, following: number, followers: number, display_name: string, is_following: boolean, is_owner: boolean, created_at: any, profile_picture: string } } };
